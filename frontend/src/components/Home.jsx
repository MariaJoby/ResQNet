      ...
      <Container maxWidth="md">
        ...
        <Typography
          ...
          sx={{
            ...
            color: '#388E3C',
            textShadow: '2px 2px 8px rgba(56, 142, 60, 0.3)',
            letterSpacing: 2,
        ...
        {/* Vision & Mission */}
        <Paper elevation={2} sx={{ p: 4, mb: 6, backgroundColor: '#e8f5e9', borderRadius: 2 }}>
          <Typography variant="h5" sx={{ color: '#388E3C', textAlign: 'center', fontWeight: 'bold' }} gutterBottom>
            What Drives Us
          </Typography>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 1 }}>
            <Box component="strong" sx={{ color: '#2e7d32' }}>Our Goal:</Box> Make assistive technology simple to find, affordable to get, and easy to trust—so that no one is left behind due to a missing wheelchair, hearing aid, or smart cane.
          </Typography>
          <Typography variant="body1" color="text.secondary">
            <Box component="strong" sx={{ color: '#2e7d32' }}>Our Promise:</Box> Whether you're buying, donating, or supporting, ResQ.Net is your space to make real impact—one device, one life, one step at a time.
          </Typography>
        </Paper>

        {/* Why ResQ.Net */}
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          <Typography variant="h4" sx={{ color: '#388E3C', fontWeight: 'bold' }} gutterBottom>
            Why ResQ.Net?
          </Typography>
        ...
        >
          {[
            ...
            <Card key={role.title} sx={{ width: 250, backgroundColor: '#f9fbe7' }} elevation={7}>
              <CardContent>
                <Typography variant="h6" sx={{ color: '#388E3C', fontWeight: 'bold' }} gutterBottom>
                  {role.title}
                </Typography>
